...
android {
    namespace = "com.example.vacacionesgeomap"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.example.vacacionesgeomap"
        minSdk = 26
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("com.google.accompanist:accompanist-coil:0.15.0") // Reemplaza con la última versión
